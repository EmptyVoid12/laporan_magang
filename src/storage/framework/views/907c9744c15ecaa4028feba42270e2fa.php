        ...
        <section class="w-full rounded-[2rem] border border-white/10 bg-slate-950/75 p-7 shadow-[0_35px_120px_rgba(2,8,23,0.55)] backdrop-blur-xl sm:p-8">
            ...
            <form wire:submit.prevent="login" class="mt-6 space-y-5">
                <div>
                    ...
                    <input
                        wire:model="email"
                        class="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-3.5 text-slate-100 placeholder:text-slate-500 focus:border-cyan-300/40 focus:outline-none <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-400/40 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input
                        wire:model="password"
                        class="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-3.5 text-slate-100 placeholder:text-slate-500 focus:border-cyan-300/40 focus:outline-none <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-400/40 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-5 text-center text-sm text-slate-300">
                <a href="<?php echo e(route('register')); ?>" class="font-semibold text-cyan-200 hover:text-cyan-100">Daftar akun baru</a>
            </div>
