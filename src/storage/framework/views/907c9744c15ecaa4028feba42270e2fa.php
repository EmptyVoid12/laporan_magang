        ...
        <section class="w-full rounded-2xl border border-slate-200 bg-white/80 p-7 shadow-sm backdrop-blur-xl sm:p-8">
            ...
            <form wire:submit.prevent="login" class="mt-6 space-y-5">
                <div>
                    ...
                    <input
                        wire:model="email"
                        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    ...
                    <input
                        wire:model="password"
                        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    <div class="mt-3 flex justify-end">
                        <a class="text-xs font-semibold text-indigo-600 hover:text-indigo-700" href="<?php echo e(route('password.request')); ?>">
                            Lupa Password?
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-5 text-center text-sm text-slate-500">
                <a href="<?php echo e(route('register')); ?>" class="font-semibold text-indigo-600 hover:text-indigo-700">Daftar akun baru</a>
            </div>
...
<?php /**PATH /var/www/html/resources/views/livewire/login-component.blade.php ENDPATH**/ ?>