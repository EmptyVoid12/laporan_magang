                                ...
                                <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications()->latest()->take(8)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="rounded-lg p-3 <?php echo e($notification->read_at ? 'bg-slate-50' : 'border-l-2 border-indigo-500 bg-indigo-50/50'); ?>">
                                        <div class="flex items-start justify-between gap-2">
                                            <div class="min-w-0">
                                                <div class="text-sm font-semibold text-slate-800"><?php echo e($notification->data['title'] ?? 'Notifikasi'); ?></div>
                                                <div class="mt-0.5 text-xs text-slate-500"><?php echo e($notification->data['message'] ?? '-'); ?></div>
                                                <?php if(!empty($notification->data['ticket_code'])): ?>
                                                    <span class="mt-1 inline-block rounded bg-slate-200 px-1.5 py-0.5 font-mono text-[10px] text-slate-600"><?php echo e($notification->data['ticket_code']); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <?php if(!empty($notification->data['url'])): ?>
                                            <a href="<?php echo e($notification->data['url']); ?>" class="mt-2 inline-block text-xs font-semibold text-indigo-600 hover:underline">Buka tiket →</a>
                                        <?php endif; ?>
                                    </div>
