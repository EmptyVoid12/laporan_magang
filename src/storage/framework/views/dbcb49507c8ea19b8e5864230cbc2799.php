...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-6 flex flex-wrap gap-3 text-sm">
                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center rounded-full bg-white px-4 py-2.5 font-black text-slate-950 transition hover:bg-cyan-100">
                    Kembali ke Login
                </a>
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center rounded-full border border-white/12 bg-white/5 px-4 py-2.5 font-semibold text-white transition hover:bg-white/10">
                    Ke beranda
                </a>
            </div>
        </section>
...
<?php /**PATH /var/www/html/resources/views/livewire/forgot-password-component.blade.php ENDPATH**/ ?>