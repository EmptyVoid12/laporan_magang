...
<?php $component->withAttributes([]); ?>
    <section class="">
        ...
        <div class="flex items-center gap-4 border-t py-6">
            <?php if($this->getCurrentTheme() instanceof \Hasnayeen\Themes\Contracts\HasChangeableColor): ?>
                <?php $__currentLoopData = $this->getColors(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button
    ...
    <section class="">
        ...
        <div class="grid grid-cols-1 gap-6 border-t py-6">
            <?php $__currentLoopData = $this->getThemes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
...
<?php endif; ?>
<?php /**PATH /var/www/html/vendor/hasnayeen/themes/resources/views/filament/pages/themes.blade.php ENDPATH**/ ?>