        ...
        <header class="rounded-2xl border border-slate-200 bg-white/80 px-5 py-4 shadow-sm backdrop-blur-xl">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-2.5">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center rounded-lg bg-white border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 shadow-sm">
                            Login
                        </a>
                ...
                <div class="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <!--[if BLOCK]><![endif]--><?php if($ticketResult): ?>
                        <div class="flex flex-wrap items-start justify-between gap-4">
                            <div>
                                <div class="text-[11px] font-bold uppercase tracking-[0.26em] text-indigo-600"><?php echo e($ticketResult->kode_tiket); ?></div>
                                <div class="mt-2 text-xl font-bold text-slate-900"><?php echo e($ticketResult->perangkat->nama_perangkat); ?></div>
                        ...
                        <div class="mt-4 grid gap-3 sm:grid-cols-2">
                            <div class="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                                ...
                                <div class="mt-2 text-sm font-bold text-slate-900"><?php echo e($ticketResult->prioritas); ?></div>
                            </div>
                            <div class="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                                <div class="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Teknisi</div>
                                <div class="mt-2 text-sm font-bold text-slate-900"><?php echo e($ticketResult->teknisi?->name ?: 'Belum diassign'); ?></div>
                            </div>
                        </div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $ticketResult->proses->sortByDesc('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="rounded-xl border border-slate-100 bg-slate-50 p-3">
                                        <div class="flex items-start justify-between gap-3">
                                            <div>
                                                <div class="text-sm font-bold text-slate-900"><?php echo e($proses->actor_name); ?></div>
                                                <div class="mt-1 text-[11px] uppercase tracking-[0.18em] text-indigo-600"><?php echo e($proses->tipe_update); ?></div>
                                            </div>
                                            <div class="text-xs text-slate-400"><?php echo e(optional($proses->tanggal_update)->format('d M Y')); ?></div>
                                        </div>
                                        <div class="mt-3 text-sm text-slate-600"><?php echo e($proses->keterangan_proses); ?></div>
                                        <!--[if BLOCK]><![endif]--><?php if($proses->kendala): ?>
                                            <div class="mt-2 text-xs text-amber-600">Kendala: <?php echo e($proses->kendala); ?></div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
            ...
            <div class="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex h-full flex-col rounded-xl border border-slate-200 bg-slate-50 p-4 transition hover:border-indigo-300/50 hover:bg-white shadow-sm">
                        ...
                        <div class="mt-4">
                            <h4 class="text-lg font-bold text-slate-900"><?php echo e($report->perangkat->nama_perangkat); ?></h4>
                            <div class="mt-2 text-sm leading-6 text-slate-500">
                        ...
                        <div class="mt-5 grid gap-3 text-sm">
                            <div class="rounded-xl border border-slate-200 bg-white px-3 py-3 shadow-sm">
                                ...
                                <div class="mt-2 font-bold text-slate-900"><?php echo e($report->prioritas); ?></div>
                            </div>
                            <div class="rounded-xl border border-slate-200 bg-white px-3 py-3 shadow-sm">
                                <div class="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">Teknisi</div>
                                <div class="mt-2 font-bold text-slate-900"><?php echo e($report->teknisi?->name ?: 'Belum diassign'); ?></div>
                            </div>
                        </div>
